...
class Listing(models.Model):
    ...
    self_contained = models.BooleanField(default=True)
    room_type = models.CharField(max_length=50, choices=RoomType.choices, default=RoomType.SINGLE)
    fenced = models.BooleanField(default=True)
    distance_to_main_road = models.DecimalField(max_digits=2, decimal_places=1)
    price = models.IntegerField()
    bedrooms = models.IntegerField()
    tiled = models.BooleanField(default=True)
    gate_keeper = models.BooleanField(default=False)
