# Generated by Django 4.0 on 2021-12-30 17:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Single', 'Single'), ('Double', 'Double'), ('Tripple', 'Tripple'), ('Full House', 'Full House')], default='Single', max_length=50)),
                ('fenced', models.BooleanField(default=True)),
                ('distance_to_main_road', models.DecimalField(decimal_places=1, max_digits=2)),
